...
const { loginUser, signupUser, logoutUser, followUser, updateProfile, updatePassword, forgotPassword, resetPassword, getUserDetails, getAccountDetails, getAllUsers, searchUsers, getUserDetailsById, deleteProfile, getManyUsers } = require('../controllers/userController');
...
router.route("/useronline/details").post(isAuthenticated, getManyUsers);
